 ...
 */
public class SelectFiltersComplexClassNonBuilderExample {
  ...
  public SelectFiltersComplexClassNonBuilderExample() {
  }

  public SelectFiltersComplexClassNonBuilderExample(String advertiserID, String campaignID, int limitFor,
  ...
  public SelectFiltersComplexClassNonBuilderExample(String advertiserID, String campaignID, String startDate,
      String endDate) {
